...
namespace MiniShopApp.Business.Concrete
{
    public class CardManager : ICardService
    {
        ...
        public void AddToCard(string userId, int productId, int quantity)
        {
            ...
            if (card != null)
            {
                var index = card.CardItems.FindIndex(i => i.ProductId == productId);    //ürün varsa 0 dan yüksek index yoksa -1 döndürür
                if (index<0)    //eğer ürün cardda yoksa
                {
                ...
                else      //eğer ürün daha önce varsa
                {
